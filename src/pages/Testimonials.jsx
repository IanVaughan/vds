...
const testimonials = [
  ...
  {
    name: "Samantha, university student",
    ...
    <section className="bg-white py-20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">What families and students say.</h1>
        </div>
